...
sy.addEventListener("click", () => {
  window.location.href = "mech-syllabus.html";
});

pyq.addEventListener("click", () => {
  window.location.href = "mech-pyq.html";
});

video.addEventListener("click", () => {
  window.location.href = "mech-video.html";
});

md.addEventListener("click", () => {
  window.location.href = "mech-model.html";
});

notes.addEventListener("click", () => {
  window.location.href = "mech-notes.html";
});

manual.addEventListener("click", () => {
  window.location.href = "mech-manual.html";
});
