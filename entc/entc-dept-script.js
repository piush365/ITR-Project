...
sy.addEventListener("click", () => {
  window.location.href = "entc-syllabus.html";
});

pyq.addEventListener("click", () => {
  window.location.href = "entc-pyq.html";
});

video.addEventListener("click", () => {
  window.location.href = "entc-video.html";
});

md.addEventListener("click", () => {
  window.location.href = "entc-model.html";
});

notes.addEventListener("click", () => {
  window.location.href = "entc-notes.html";
});

manual.addEventListener("click", () => {
  window.location.href = "entc-manual.html";
});
