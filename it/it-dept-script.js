...
sy.addEventListener("click", () => {
  window.location.href = "it-syllabus.html";
});

const pyq = document.querySelector("#pyq");

pyq.addEventListener("click", () => {
  window.location.href = "it-pyq.html";
});

const video = document.querySelector("#video");

video.addEventListener("click", () => {
  window.location.href = "it-video.html";
});

const md = document.querySelector("#md");

md.addEventListener("click", () => {
  window.location.href = "it-model.html";
});

const notes = document.querySelector("#notes");

notes.addEventListener("click", () => {
  window.location.href = "it-notes.html";
});

const manual = document.querySelector("#manual");

manual.addEventListener("click", () => {
  window.location.href = "it-manual.html";
});
